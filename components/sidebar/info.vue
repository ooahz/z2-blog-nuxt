...
.author-info {
  ...
  background: linear-gradient(to bottom,
      rgba(var(--z-common-bg), .5) 0%,
      rgba(var(--z-common-bg), .8) 40%,
      rgba(var(--z-common-bg)) 60%,
      rgba(var(--z-common-bg))),
  url(https://s.ahzoo.cn/picture/22436164.png) no-repeat center;
